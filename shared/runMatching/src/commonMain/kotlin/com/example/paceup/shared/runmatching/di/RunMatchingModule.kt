...
import com.example.paceup.shared.runmatching.data.SupabaseReportRepository
...
/** Koin bindings for run discovery, group chat, partner ratings, blocking, and reporting. Requires [SupabaseClient] from supabaseModule. */
val runMatchingModule = module {
    ...
    single<ReportRepository> { SupabaseReportRepository(get()) }
}
